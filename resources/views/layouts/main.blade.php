    ...
    <div class="container-fluid bg-info py-3">
        <header>
            <div class="row align-items-center">
                ...
                <div class="col">
                    <img src="assets/img/list.png" alt="" width="30" height="30">
                </div>
                <div class="col">
                    <img src="assets/img/man.png" alt="" width="30" height="30">
                </div>
            </div>
            <div class="row-12 py-3">

                <nav class="navbar navbar-light bg-light">
                    <form class="container-fluid justify-content-start text-center">
                        <div class="container text-center">
                            <button class="btn btn-outline-success me-2" type="button">Sugesti</button>
                            <button class="btn btn-outline-success me-2" type="button">Sugesti</button>
                            <button class="btn btn-outline-success me-2" type="button">Sugesti</button>
                            <button class="btn btn-outline-success me-2" type="button">Sugesti</button>
                            <button class="btn btn-outline-success me-2" type="button">Sugesti</button>
